...
import { Observable, catchError, throwError, BehaviorSubject, switchMap, finalize, filter, take } from "rxjs";
 ...
 */
export const getIsRefreshingToken = (): boolean =>
  isRefreshingToken$.getValue();
/**
